...
[
  ...
  {
      "name": "mcp-server",
      "image": "quay.io/redhat-user-workloads/crt-nshift-lightspeed-tenant/kubernetes-mcp-server-f302c:a3fb7106596a1026dcbc8ed7ef7bbec7b90798db"
  }
]
EOF
  )
...
${YQ} "(.spec.install.spec.deployments[].spec.template.spec.containers[].args[] |= sub(\"quay.io/redhat-user-workloads/crt-nshift-lightspeed-tenant/kubernetes-mcp-server-f302c:a3fb7106596a1026dcbc8ed7ef7bbec7b90798db\", ${MCP_SERVER_IMAGE}))" -i ${CSV_FILE}
