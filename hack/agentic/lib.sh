...
OPERATOR_IMG="${INTERNAL_REG}/${NS_OPERATOR}/${BC_OPERATOR}:${TAG}"
CONSOLE_IMG="${INTERNAL_REG}/${NS_OPERATOR}/${BC_CONSOLE}:${TAG}"
AGENT_IMG="${INTERNAL_REG}/${NS_OPERATOR}/${BC_AGENT}:${TAG}"
SKILLS_IMG="${INTERNAL_REG}/${NS_OPERATOR}/${BC_SKILLS}:${TAG}"
