...
9. Three component groups are reconciled in Phase 1: Console UI, PostgreSQL, and either AppServer or LCore (mutually exclusive based on --use-lcore flag).
...
### Owned Resources
30. The operator sets owner references on all created resources (except cluster-scoped ConsolePlugin).
31. Owned resource types: Deployments, ServiceAccounts, ClusterRoles, ClusterRoleBindings, Services, ConfigMaps, Secrets, PersistentVolumeClaims, ConsolePlugins, ServiceMonitors, PrometheusRules, ImageStreams.
