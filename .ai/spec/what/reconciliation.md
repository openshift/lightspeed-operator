...
11e. OTEL Collector Phase 1 resources (OLS-3510): ConfigMap (collector runtime YAML `lightspeed-otel-collector-config`), ServiceAccount, Postgres DSN Secret, NetworkPolicy.
...
| OLS-3526 | MCP server standalone Deployment, Service, SA, TLS, NetworkPolicy as a new reconciliation component group |
