...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *RedisCredentialsSpec) DeepCopyInto(out *RedisCredentialsSpec) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new RedisCredentialsSpec.
func (in *RedisCredentialsSpec) DeepCopy() *RedisCredentialsSpec {
	if in == nil {
		return nil
	}
	out := new(RedisCredentialsSpec)
	in.DeepCopyInto(out)
	return out
}
