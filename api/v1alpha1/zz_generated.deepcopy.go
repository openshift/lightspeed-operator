...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *PodDeploymentConfig) DeepCopyInto(out *PodDeploymentConfig) {
	*out = *in
	if in.Replicas != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new PodDeploymentConfig.
func (in *PodDeploymentConfig) DeepCopy() *PodDeploymentConfig {
	if in == nil {
		return nil
	}
	out := new(PodDeploymentConfig)
	in.DeepCopyInto(out)
	return out
}
