...
func (in *OLSSpec) DeepCopyInto(out *OLSSpec) {
	*out = *in
	...
	in.UserDataCollection.DeepCopyInto(&out.UserDataCollection)
...
func (in *UserDataCollectionSpec) DeepCopyInto(out *UserDataCollectionSpec) {
	*out = *in
	if in.FeedbackDisabled != nil {
		in, out := &in.FeedbackDisabled, &out.FeedbackDisabled
		*out = new(bool)
		**out = **in
	}
	if in.TranscriptsDisabled != nil {
		in, out := &in.TranscriptsDisabled, &out.TranscriptsDisabled
		*out = new(bool)
		**out = **in
	}
}
