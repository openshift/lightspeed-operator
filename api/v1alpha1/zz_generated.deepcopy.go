...
func (in *MCPServer) DeepCopyInto(out *MCPServer) {
	*out = *in
	if in.StreamableHTTP != nil {
		...
		*out = new(MCPServerStreamableHTTPTransport)
		(*in).DeepCopyInto(*out)
	}
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *MCPServerStreamableHTTPTransport) DeepCopyInto(out *MCPServerStreamableHTTPTransport) {
	*out = *in
	if in.Headers != nil {
...
func (in *MCPServerStreamableHTTPTransport) DeepCopy() *MCPServerStreamableHTTPTransport {
	if in == nil {
		return nil
	}
	out := new(MCPServerStreamableHTTPTransport)
