...
func (in *DeploymentConfig) DeepCopyInto(out *DeploymentConfig) {
	*out = *in
	...
	if in.AgenticConsoleContainer != nil {
		in, out := &in.AgenticConsoleContainer, &out.AgenticConsoleContainer
		*out = new(Config)
		(*in).DeepCopyInto(*out)
	}
	in.DatabaseContainer.DeepCopyInto(&out.DatabaseContainer)
	if in.AlertsAdapter != nil {
		in, out := &in.AlertsAdapter, &out.AlertsAdapter
		*out = new(AlertsAdapterSpec)
		(*in).DeepCopyInto(*out)
	}
}
