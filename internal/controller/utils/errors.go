...
const (
	...
	ErrCreateAlertsAdapterAgenticRunsRole                    = "failed to create alerts adapter agenticruns role"
	ErrCreateAlertsAdapterAgenticRunsRoleBinding             = "failed to create alerts adapter agenticruns role binding"
	ErrCreateAlertsAdapterAgenticOLSConfigClusterRole        = "failed to create alerts adapter agenticolsconfig cluster role"
	ErrCreateAlertsAdapterAgenticOLSConfigClusterRoleBinding = "failed to create alerts adapter agenticolsconfig cluster role binding"
	...
	ErrGenerateAlertsAdapterAgenticRunsRole                    = "failed to generate alerts adapter agenticruns role"
	ErrGenerateAlertsAdapterAgenticRunsRoleBinding             = "failed to generate alerts adapter agenticruns role binding"
	ErrGenerateAlertsAdapterAgenticOLSConfigClusterRole        = "failed to generate alerts adapter agenticolsconfig cluster role"
	ErrGenerateAlertsAdapterAgenticOLSConfigClusterRoleBinding = "failed to generate alerts adapter agenticolsconfig cluster role binding"
	...
	ErrGetAlertsAdapterAgenticRunsRole                         = "failed to get alerts adapter agenticruns role"
	...
	ErrGenerateOpenShiftMCPServerServiceMonitor          = "failed to generate openshift-mcp-server ServiceMonitor"
	ErrSetOpenShiftMCPServerServiceMonitorOwnerReference = "failed to set openshift-mcp-server ServiceMonitor owner reference"
