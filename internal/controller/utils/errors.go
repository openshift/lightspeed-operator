...
const (
	...
	ErrCreateAlertsAdapterProposalsClusterRole          = "failed to create alerts adapter proposals cluster role"
	ErrCreateAlertsAdapterProposalsClusterRoleBinding   = "failed to create alerts adapter proposals cluster role binding"
	...
	ErrGenerateAlertsAdapterProposalsClusterRole        = "failed to generate alerts adapter proposals cluster role"
	ErrGenerateAlertsAdapterProposalsClusterRoleBinding = "failed to generate alerts adapter proposals cluster role binding"
	...
	ErrGetAlertsAdapterProposalsClusterRole             = "failed to get alerts adapter proposals cluster role"
	ErrGetAlertsAdapterProposalsClusterRoleBinding      = "failed to get alerts adapter proposals cluster role binding"
