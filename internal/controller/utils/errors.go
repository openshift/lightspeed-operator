...
const (
	...
	ErrGenerateOtelCollectorPostgresSecret                = "failed to generate OTEL Collector Postgres secret"
	...
	ErrSetOtelCollectorPostgresSecretOwnerReference       = "failed to set OTEL Collector Postgres secret owner reference"
	...
	ErrCreateOtelCollectorPostgresSecret                  = "failed to create OTEL Collector Postgres secret"
	ErrGetOtelCollectorPostgresSecret                     = "failed to get OTEL Collector Postgres secret"
	ErrUpdateOtelCollectorPostgresSecret                  = "failed to update OTEL Collector Postgres secret"
