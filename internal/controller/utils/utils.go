...
func GetProxyCACertKey(proxyCACertRef *corev1.ConfigMapKeySelector) string {
...
func GetProxyCACertConfigMapName(proxyCACertRef *corev1.ConfigMapKeySelector) string {
	if proxyCACertRef == nil || proxyCACertRef.LocalObjectReference.Name == "" {
		return ""
	}
	return proxyCACertRef.LocalObjectReference.Name
}
