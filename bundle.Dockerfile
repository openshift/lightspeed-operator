...
ARG MCP_SERVER_IMAGE_ORIGINAL=quay.io/redhat-user-workloads/crt-nshift-lightspeed-tenant/kubernetes-mcp-server-f302c:a3fb7106596a1026dcbc8ed7ef7bbec7b90798db
